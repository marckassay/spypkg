...
var shellExe = (process.platform === 'win32') ? 'cmd /c' : '';
var npmExe = (RegExp(/.*([Y|y]arn[\\|\/]bin).*/gm).test(process.env.PATH)) ? 'yarn' : 'npm';
var command = (shellExe + ' ' + npmExe + '  add-altpackage').trimLeft();
