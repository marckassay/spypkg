...
var spawn = util_1.promisify(child.spawn);
var options = {
    stdio: 'inherit',
    shell: true
};
var exe = function (expression) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, spawn(expression, options)
